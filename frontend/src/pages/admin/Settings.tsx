  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-1 mb-4 border-b border-[#E4E4E7]">
        {[{ key: 'users', label: 'Сотрудники' }, { key: 'types', label: 'Типы заявок' }, { key: 'equipment_fields', label: 'Характеристики оборудования' }, { key: 'brands', label: 'Марка' }, { key: 'doc_types', label: 'Типы документов' }].map(t => (
